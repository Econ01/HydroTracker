...
val hydroTrackerSmoothShapes = Shapes(
    extraSmall = AbsoluteSmoothCornerShape(2.dp),
    small = AbsoluteSmoothCornerShape(4.dp),
    medium = AbsoluteSmoothCornerShape(8.dp),
    large = AbsoluteSmoothCornerShape(12.dp),
    largeIncreased = AbsoluteSmoothCornerShape(16.dp),
    extraLarge = AbsoluteSmoothCornerShape(24.dp),
    extraLargeIncreased = AbsoluteSmoothCornerShape(28.dp),
    extraExtraLarge = AbsoluteSmoothCornerShape(34.dp),
)
...
fun HydroTrackerTheme(
    ...
    MaterialTheme(
        shapes = hydroTrackerSmoothShapes,
