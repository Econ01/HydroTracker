        ...
        ModalBottomSheet(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = "Use slider to adjust: ${String.format(LocalLocale.current.platformLocale, "%.2f", sliderValue)} L",
                ...
                Column(
                    ...
                    OutlinedTextField(
                        shape = AbsoluteSmoothCornerShape(12.dp),
                        value = goalText,
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Row(
                                    ...
                                    Text(
                                        text = String.format(LocalLocale.current.platformLocale, "%02d:%02d", wakeUpHour, wakeUpMinute),
                                        style = MaterialTheme.typography.headlineSmall,
                                        fontWeight = FontWeight.Bold
                                    )
                                }
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Row(
                                    ...
                                    Text(
                                        text = String.format(LocalLocale.current.platformLocale, "%02d:%02d", sleepHour, sleepMinute),
                                        style = MaterialTheme.typography.headlineSmall,
                                        fontWeight = FontWeight.Bold
                                    )
                                }
