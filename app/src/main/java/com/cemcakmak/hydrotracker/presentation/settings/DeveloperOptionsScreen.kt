...
fun DeveloperOptionsScreen(
    ...
    SettingsDetailScaffold(
        ...
        if (HealthConnectManager.isVersionSupported() &&
            (userProfile?.healthConnectSyncEnabled == true || isPreview)
        ) {
...
/** Title + grouped list of action cards, matching the other settings sections. */
@Composable
...
/** Read-only diagnostic card (no click target). */
@Composable
